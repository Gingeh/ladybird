...
public:
    ...
    Vector<GC::Ref<HTML::HTMLElement>>& open_dialogs_list() { return m_open_dialogs_list; }

    void set_dialog_pointerdown_target(GC::Ptr<HTML::HTMLElement> target) { m_dialog_pointerdown_target = target; }
    GC::Ptr<HTML::HTMLElement> dialog_pointerdown_target() { return m_dialog_pointerdown_target; }
...
private:
    ...
    Vector<GC::Ref<HTML::HTMLElement>> m_open_dialogs_list;
    GC::Ptr<HTML::HTMLElement> m_dialog_pointerdown_target;
